		...
		<div className="w-full max-w-7xl mx-auto p-4 lg:p-6">
			<div className="flex flex-col lg:flex-row gap-4 lg:gap-6">
				<div className="flex-1 lg:flex-[3] h-full">
					<div
						ref={filterPanelRef}
						className="bg-white/80 backdrop-blur rounded-2xl shadow-lg pt-0 pb-4 lg:pb-6 px-4 lg:px-6 min-h-[340px] h-full flex flex-col justify-center dark:bg-white/80 transition-all duration-500"
					>
						<form onSubmit={handleSubmit} className="flex flex-col h-full">
							<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mt-4 mb-4 lg:mb-6 gap-4">
								<h1
									className="text-xl lg:text-2xl xl:text-3xl font-extrabold text-left bg-clip-text text-transparent bg-gradient-to-r from-purple-900 via-purple-800 to-purple-900"
								...
								<div className="flex flex-col sm:flex-row gap-2 sm:gap-3 justify-end">
									<button
										type="button"
										onClick={handleReset}
										className="px-4 lg:px-6 py-2 bg-white border-2 border-purple-300 text-purple-700 rounded-lg hover:bg-purple-50 transition-colors font-semibold text-xs lg:text-sm flex items-center gap-2 justify-center"
									>
										<RefreshCw className="w-4 h-4" /> Limpiar
									</button>
									<button
										type="submit"
										className="px-4 lg:px-6 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors font-semibold shadow-lg text-xs lg:text-sm flex items-center gap-2 justify-center"
									>
										<Search className="w-4 h-4" /> Aplicar
									</button>
								</div>
							</div>
							<div className="flex w-full bg-gray-100 rounded-2xl p-1 gap-0 shadow-inner mb-4 lg:mb-6 overflow-x-auto">
								<button
									type="button"
									onClick={() => setActiveTab("basic")}
									className={`flex-1 flex items-center justify-center gap-1 py-2 px-2 lg:px-3 font-medium text-xs lg:text-sm rounded-2xl transition-all duration-200 focus:outline-none whitespace-nowrap ${activeTab === "basic" ? "bg-white text-purple-700 border-b-2 border-purple-500" : "bg-transparent text-gray-500 hover:text-purple-700"}`}
								...
								<button
									...
									className={`flex-1 flex items-center justify-center gap-1 py-2 px-2 lg:px-3 font-medium text-xs lg:text-sm rounded-2xl transition-all duration-200 focus:outline-none whitespace-nowrap ${activeTab === "engagement" ? "bg-white text-purple-700 border-b-2 border-purple-500" : "bg-transparent text-gray-500 hover:text-purple-700"}`}
									style={{ boxShadow: undefined }}
								>
									<Sliders
								...
								<button
									...
									className={`flex-1 flex items-center justify-center gap-1 py-2 px-2 lg:px-3 font-medium text-xs lg:text-sm rounded-2xl transition-all duration-200 focus:outline-none whitespace-nowrap ${activeTab === "advanced" ? "bg-white text-purple-700 border-b-2 border-purple-500" : "bg-transparent text-gray-500 hover:text-purple-700"}`}
									style={{ boxShadow: undefined }}
								>
									<Globe
								...
								<button
									...
									className={`flex-1 flex items-center justify-center gap-1 py-2 px-2 lg:px-3 font-medium text-xs lg:text-sm rounded-2xl transition-all duration-200 focus:outline-none whitespace-nowrap ${activeTab === "fecha" ? "bg-white text-purple-700 border-b-2 border-purple-500" : "bg-transparent text-gray-500 hover:text-purple-700"}`}
									style={{ boxShadow: undefined }}
								>
									<Calendar
							...
							<div className="flex flex-col gap-4 lg:gap-6 flex-1">
											...
											<div key={key}>
												...
												<div className="flex gap-2">
													<input
														...
														className="w-1/2 border-2 border-purple-200 bg-white px-2 lg:px-3 py-1.5 rounded-lg focus:outline-none focus:ring-purple-300 transition text-xs lg:text-sm text-gray-900"
														min={0}
													/>
													<input
														type="number"
								...
								{activeTab === "fecha" && (
									<div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
										<div>
											<label className="block mb-1 font-semibold text-gray-700 text-sm lg:text-base">
				...
				<div className="lg:w-80 lg:flex-shrink-0 h-full flex items-center justify-center">
					<div
						...
						className="relative w-full max-w-sm mx-auto bg-white/80 backdrop-blur rounded-2xl shadow-xl px-6 lg:px-10 py-6 lg:py-8 flex flex-col justify-center items-center transition-all duration-500"
					>
						<DbHelpCarousel />
					</div>
				</div>
