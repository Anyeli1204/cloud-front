...
export default function EditProfileModal({
  ...
  const handleSubmit = async () => {
    try {
      setLoading(true);
      setError(null);
      await axios.patch(`http://localhost:8080/user/update/${userId}`, formData, {
            headers: {
  ...
  return (
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm z-50 flex items-center justify-center">
      <div className="bg-gradient-to-br from-pink-100 to-white dark:from-purple-900 dark:to-black w-full max-w-md p-6 rounded-xl shadow-xl relative border border-purple-300">
        ...
        <h2 className="text-2xl font-bold text-purple-700 mb-1">Editar Perfil</h2>
        <p className="text-sm text-gray-500 mb-4">Actualiza tu información personal y hazla brillar ✨</p>
